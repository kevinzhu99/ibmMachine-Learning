...
#wget.download(url, "C:/Users/kevin/Desktop/Cust_Segmentation.csv")
cust_df = pd.read_csv(r"C:/Users/kevin/Desktop/Cust_Segmentation.csv")
print(cust_df.head())
...
X = df.values[:, 1:]
X = np.nan_to_num(X)
Clus_dataset = StandardScaler(X).fit_transform(X)
print(Clus_dataset)
